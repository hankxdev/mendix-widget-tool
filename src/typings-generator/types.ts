...
export interface PackageXml {
    package: {
        clientModule: PackageClientModule[];
    };
}

export interface PackageClientModule {
    $: {
        name: string;
        version: string;
    };
    widgetFiles: PackageWidgetFiles[];
    files?: PackageFiles[];
}

export interface PackageWidgetFiles {
    widgetFile: PackageWidgetFile[];
}

export interface PackageWidgetFile {
    $: {
        path: string;
    };
}
